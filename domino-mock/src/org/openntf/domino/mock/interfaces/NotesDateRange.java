 ...
 * 
 * @author Sven Dreher
 * @access To create a new DateRange object, use createDateRange in Session. To initialize the object, you can do one of the following:
 *         <ul>
 *         <li>Assign values to the createDateRange parameters.</li>
 *         <li>Assign to StartDateTime and EndDateTime DateTime values.</li>
 *         <li>Assign to Text a string value that represents a date range. This consists of two string representations of Domino-formatted date-time values separated by a hyphen (for example,
 *         "01/01/97 - 01/02/97").</li>
 *         </ul>
 * @usage When you assign StartDateTime or EndDateTime, its value replaces the corresponding value in Text, and vice versa
 * @example 1. This example sets the StartDateTime and EndDateTime properties of a DateRange object through the createDateRange parameters, then displays the value of the Text property
 * 
 *          <pre>
 * import lotus.domino.*;
 * 
 ...
 * 			System.out.println(&quot;Start date = &quot; + dr.getStartDateTime().getLocalTime());
 * 			System.out.println(&quot;End date = &quot; + dr.getEndDateTime().getLocalTime());
 * 		} catch (Exception e) {
 * 			e.printStackTrace();
 * 		}
 * 	}
...
public interface NotesDateRange extends NotesBase {
	 ...
	 * @usage Modifying the DateTime object on which StartDateTime is based implicitly modifies StartDateTime. This does not apply if StartDateTime is based on a java.util.Date object.
	 * 
	 ...
	 * @throws NotesApiException
	 * @usage Modifying the DateTime object on which EndDateTime is based implicitly modifies EndDateTime. This does not apply if EndDateTime is based on a java.util.Date object.
	 * 
	 ...
	 * 
	 * @return The text associated with a range formatted as Domino date-time text
	 * @throws NotesApiException
	 */
